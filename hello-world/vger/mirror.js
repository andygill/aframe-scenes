AFRAME.registerShader('line-dashed', {
   ...
   */
  init: function (data) {
          console.log("dash",data,document.getElementsByTagName("a-scene"))

    var camera = document.getElementsByTagName("a-scene")[0].camera;
    var renderer = document.getElementsByTagName("a-scene")[0].renderer;
    this.material = new THREE.Mirror( renderer,
                                      camera,
                                      { clipBias: 0.003,
                                        textureWidth: 1024,
                                        textureHeight: 1024,
  ...
  tickX: function (data) {
          ...
          console.log(camera,renderer,this.mirrorNotUpdated)
      if (camera && renderer && this.mirrorNotUpdated) {
              this.mirrorNotUpdated = false;
              var camera = document.getElementsByTagName("a-scene")[0].camera;
              var renderer = document.getElementsByTagName("a-scene")[0].renderer;
